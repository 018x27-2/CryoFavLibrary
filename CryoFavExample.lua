...
local Library = loadstring(game:HttpGet(repo .. 'CryoFavLibrary.lua'))()
local ThemeManager = loadstring(game:HttpGet(repo .. 'addons/ThemeManager.lua'))()
local SaveManager = loadstring(game:HttpGet(repo .. 'addons/SaveManager.lua'))()

local Window -- Declare Window variable outside the if statement
...
if platform == "PC" then
    Window = Library:CreateWindow({
        ...
        Center = true,
        AutoShow = true,
        Size = UDim2.new(0, 530, 0, 700),
        TabPadding = 8,
        MenuFadeTime = 0.2
    })
    print("User is on Roblox PC.")
elseif platform == "Mobile" then
    Window = Library:CreateWindow({
        Title = 'Example menu',
        Center = true,
        AutoShow = true,
        Size = UDim2.new(0, 530, 0, 323),
        TabPadding = 8,
        MenuFadeTime = 0.2
    })
    print("User is on Roblox Mobile.")
else
    print("Unable to determine platform.")
end

-- Now you can use the Window variable later in the script
...
Options.KeyPicker:SetValue({ 'Z', 'Toggle' }) -- Sets keybind to MB2, mode to Hold
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Server stats | %s fps | %s ms'):format(
        math.floor(FPS),
...
MenuGroup:AddButton('Unload', function() ScreenGui.Destroy end)
